...
#include <room_segmentation/timer.h>
#include <room_segmentation/evaluation_segmentation.h>
...
////		"NLB" //done
	...
	const std::string segmented_map_path = "room_segmentation/"; //ros::package::getPath("room_segmentation") + "/common/files/segmented_maps/";
	...
	for (size_t image_index = 0; image_index<map_names.size(); ++image_index)
	{
		...
		std::string image_filename = ros::package::getPath("room_segmentation") + "/common/files/test_maps/" + map_name + ".png";
		...
		//	cv_image.header.stamp = ros::Time::now();
			...
			room_segmentation::MapSegmentationResultConstPtr result = ac.getResult();
...
//			}
			...
			std::string gt_image_filename = ros::package::getPath("room_segmentation") + "/common/files/test_maps/" + map_name_basic + "_gt_segmentation.png";
			...
			std::string gt_image_filename_color = segmented_map_path + map_name + "_gt_color_segmentation.png"; //ros::package::getPath("room_segmentation") + "/common/files/test_maps/" + map_name + "_gt_color_segmentation.png";
